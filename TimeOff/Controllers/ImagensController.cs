...
namespace TimeOff.Controllers
{
    public class ImagensController : Controller
    {
        ...
        {
            var imagens = db.Imagens.Include(i => i.Filmes);
        ...
        public ActionResult Create([Bind(Include = "Id,Imagem,FilmeId")] Imagens imagens)
        {
            ...
            ViewBag.FilmeId = new SelectList(db.Filmes, "Id", "Titulo", imagens.FilmeId);
            return View(imagens);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Imagem,FilmeId")] Imagens imagens)
        {
            if (ModelState.IsValid)
            {
